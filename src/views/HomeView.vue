<template>
  <main>
    <div class="card treeview-animated w-20 border mx-4 my-4">
      <h1 class="card-header text-center">
        View Tree Window
        <router-link :to="{ name: 'AddFolder', params: { FolderId: 0 } }">
          <span> <Icon icon="fluent:folder-add-24-filled" />  </span>
        </router-link>
      </h1>
      <treeView v-for="folder in folders" :folder="folder" class="ml-2" />
    </div>
  </main>
</template>
